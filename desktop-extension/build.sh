...
#
#   bash desktop-extension/build.sh    ->  desktop-extension/thrivecart-<version>.mcpb
set -euo pipefail
...
npx -y @anthropic-ai/mcpb@latest pack "$build" "$root/desktop-extension/thrivecart-$version.mcpb"

echo
echo "Built desktop-extension/thrivecart-$version.mcpb"
