...
**Errors say what to fix.** Typed errors naming the likely cause — wrong host, account password instead of an API key, a record belonging to another cart — instead of `ThriveCart API error 401`.
